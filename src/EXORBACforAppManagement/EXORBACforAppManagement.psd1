...
FunctionsToExport = 'New-RBAC4AppEntry', 'New-RegisteredApp', 'Get-RBAC4AppEntry', 'Get-RegisteredAppWithPermission', 'New-RBAC4AppUnifiedGroup', 'New-RBAC4AppDistributionGroup', 'Register-EXOServicePrincipal', 'Convert-ApplicationAccessPolicyToRBAC', 'Test-RBAC4AppEntry', 'Remove-RBAC4AppEntry', 'Set-RBAC4AppEntry', 'New-RBAC4AppConfig', 'Invoke-RBAC4AppConfig'
...
# Backward-compatible aliases: the pre-0.6.0 RBACforApp names point to the RBAC4App functions.
AliasesToExport = 'New-RBACforAppEntry', 'Get-RBACforAppEntry', 'Set-RBACforAppEntry', 'Test-RBACforAppEntry', 'Remove-RBACforAppEntry', 'New-RBACforAppUnifiedGroup', 'New-RBACforAppDistributionGroup'
